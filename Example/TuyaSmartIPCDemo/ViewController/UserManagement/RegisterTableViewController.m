...
- (IBAction)sendVerificationCode:(UIButton *)sender {
    if ([self.accountTextField.text containsString:@"@"]) {
        ...
        [[TuyaSmartUser sharedInstance] sendVerifyCodeWithUserName:self.accountTextField.text region:region countryCode:self.countryCodeTextField.text type:1 success:^{
